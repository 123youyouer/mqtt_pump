...
namespace redis_agent{
    ...
    void listen_proc(std::shared_ptr<pump::dpdk::net::tcp_listener> l){
...
main(int argc, char * argv[]){
    redis_agent::redis::redis_servers.emplace(redis_agent::redis::consistent_hash_node{std::shared_ptr<redis_agent::redis::redis_node>(nullptr),1});
    redis_agent::redis::redis_servers.emplace(redis_agent::redis::consistent_hash_node{std::shared_ptr<redis_agent::redis::redis_node>(nullptr),10});
    redis_agent::redis::redis_servers.emplace(redis_agent::redis::consistent_hash_node{std::shared_ptr<redis_agent::redis::redis_node>(nullptr),15});
    redis_agent::redis::redis_servers.emplace(redis_agent::redis::consistent_hash_node{std::shared_ptr<redis_agent::redis::redis_node>(nullptr),100});
    auto x=redis_agent::redis::redis_servers.find(12);
