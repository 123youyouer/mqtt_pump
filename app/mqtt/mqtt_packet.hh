...
namespace mqtt{
    ...
    struct mqtt_pkt_connect:boost::noncopyable{
        struct _inner_data{
            ...
            bool
            read_fixed_head(pump::common::ringbuffer* buf){
            ...
            bool
            read_payload(pump::common::ringbuffer* buf){
            ...
            bool
            from_buf(pump::common::ringbuffer* buf){
        ...
        explicit
        mqtt_pkt_connect(u_int8_t cmd,u_int32_t remaining,pump::common::ringbuffer* others):data(new _inner_data()){
            this->data->cmd=cmd;
    ...
    struct mqtt_pkt_publish:boost::noncopyable{
        struct _inner_data{
            ...
            bool from_buf(pump::common::ringbuffer* buf){
        ...
        explicit
        mqtt_pkt_publish(u_int8_t cmd,u_int32_t remaining,pump::common::ringbuffer* others):data(new _inner_data()){
            data->cmd=cmd;
    ...
    struct mqtt_pkt_subscribe:boost::noncopyable{
        ...
        explicit
        mqtt_pkt_subscribe(u_int8_t cmd,u_int32_t remaining,pump::common::ringbuffer* others):data(new _inner_data()){
            data->cmd=cmd;
            data->remaining=remaining;
            data->from_buf(others);
        }
    ...
    struct mqtt_pkt_unsubscribe:boost::noncopyable{
        ...
        explicit
        mqtt_pkt_unsubscribe(u_int8_t cmd,u_int32_t remaining,pump::common::ringbuffer* others):data(new _inner_data()){
            data->cmd=cmd;
            data->remaining=remaining;
            data->from_buf(others);
        }
