...
namespace reactor{
    ...
    schedule_to<reactor::task_schedule_center<net::_read_event_type_>>{
        ...
        apply(
                ...
                utils::noncopyable_function<void(net::_read_event_type_&&)>&& f){
            dst->push(std::forward<utils::noncopyable_function<void(net::_read_event_type_&&)>>(f));
        }
    };
    ...
    schedule_to<_T0,reactor::task_schedule_center<net::_read_event_type_>>{
        ...
        apply(
            ...
            schedule_to<reactor::task_schedule_center<net::_read_event_type_>>::apply(
                    dst,
                    std::forward<utils::noncopyable_function<void(net::_read_event_type_&&)>>(f));
        }
    };
    template <>
    class
    ...
    schedule_to<reactor::task_schedule_center<net::session_sendable_event>>{
        static void
        apply(reactor::task_schedule_center<net::session_sendable_event>* dst,utils::noncopyable_function<void(net::session_sendable_event&&)>&& f){
