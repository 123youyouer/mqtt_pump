...
namespace engine::dpdk{
    ...
    void load_config(boost::property_tree::ptree& t){
        glb_dpdk_config.lcore_mask=t.get<std::string>("init.lcore_mask");
        //glb_dpdk_config.base_virtaddr=(t.find("init.base_virtaddr")==t.not_found())?"":t.get<std::string>("init.base_virtaddr");
        glb_dpdk_config.nb_channel=t.get<int>("init.nb_channel");
        glb_dpdk_config.promiscuous=t.get<int>("init.promiscuous");
        glb_dpdk_config.numa_on=t.get<int>("init.numa_on");
        glb_dpdk_config.tso=t.get<int>("init.tso");
        glb_dpdk_config.tx_csum_offoad_skip=t.get<int>("init.tx_csum_offoad_skip");
        glb_dpdk_config.pkt_tx_delay=t.get<unsigned>("init.pkt_tx_delay");
