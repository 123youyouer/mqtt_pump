...
* - vdev init name, for example- net_[pcap0|null0|tap0]
*
* @param name
...
* - SoC device name, for example- fsl-gmac0
* - vdev init name, for example- net_[pcap0|null0|tun0|tap0]
*
* @param port_id
 ...
 *
 * - It allows a run-to-completion network stack dpdk to retrieve and
